...
if [[ "$(uname -s)" == Darwin ]]; then
  ...
  BIONIC_OBJECTS=("$OBJ/host-services.o" "$OBJ/thread-attr.o" "$OBJ/agr_futex_host.o" "$OBJ/agr_bionic_sync.o" "$OBJ/agr_bionic_tls.o" "$OBJ/agr_bionic_errno_host.o" "$OBJ/agr_bionic_clock.o" "$OBJ/agr_bionic_thread_lifecycle.o")
else
  BIONIC_OBJECTS=()
fi
...
clang++ "$OBJ/test.o" "$OBJ/vma.o" "$OBJ/runtime.o" "$OBJ/allocator.o" "$OBJ/linker.o" "$OBJ/dynamic.o" "$OBJ/mmap.o" "${BIONIC_OBJECTS[@]}" -pthread -lm -o "$OUT"
"$OUT"
