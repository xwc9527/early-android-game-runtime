 ...
 * Retained policy functions: phdr_table_get_load_size, ReserveAddressSpace,
 * LoadSegments, _phdr_table_set_load_prot, phdr_table_protect_segments, and
 * phdr_table_protect_gnu_relro. AGR PORT markers identify host-boundary edits.
 */
...
/* Unmodified AOSP load-span policy; only types/macros come from the port header. */
