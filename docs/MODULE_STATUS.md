...
| Phase 3 final gate | active | DALVIK_VM | not closed | Phase 3 final JNI contract | JNI static field getters or Call variants still return a default. A game-observed missing Framework API is not this gate |
