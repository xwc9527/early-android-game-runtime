...
| Phase 3 final gate | active | DALVIK_VM | not closed | Tests/DexLoom/jni-call-host.c | Reopen if a JNI Call variant or static field getter returns a default without invoking or reading the slot and without a pending exception |
