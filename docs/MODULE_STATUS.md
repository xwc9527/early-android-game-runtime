...
| Framework traversal dispatch / draw consumer | active | — | host traversal-dispatch contract and one focused Simulator normal-path probe | a production change to measure, relayout, layout, or Surface identity follows the first-traversal reopen rule |
